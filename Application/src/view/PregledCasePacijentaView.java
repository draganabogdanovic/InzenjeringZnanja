...
public class PregledCasePacijentaView extends JPanel {

	
	private PregledPacijenta pregled;
	private PregledController pregledCon;
	...
	private JList<String> bolesti;
	private JList<String> izabraneBolesti;
	private DefaultListModel<String> dlmBolesti;
	...
	private JPanel panelBolesti;
	private JLabel dijagnoza;
	...
	public PregledCasePacijentaView(PregledPacijenta pacijent) {
		initGUI();
		constructGUI();
